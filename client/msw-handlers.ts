...
export interface MSWHandlers {
  ...
  certificateDeleteV1: (params: {
    path: Api.CertificateDeleteV1PathParams;
  }) => StatusCode;
  ...
  ipPoolCreateV1: (params: {
    body: Json<Api.IpPoolCreate>;
  }) => HandlerResult<Api.IpPool>;
  /** `GET /v1/system/ip-pools/:pool` */
  ipPoolViewV1: (params: {
    path: Api.IpPoolViewV1PathParams;
  }) => HandlerResult<Api.IpPool>;
  ...
  ipPoolDeleteV1: (params: {
    path: Api.IpPoolDeleteV1PathParams;
  }) => StatusCode;
  ...
  ipPoolServiceRangeRemoveV1: (params: {
    body: Json<Api.IpRange>;
  }) => StatusCode;
...
export function makeHandlers(handlers: MSWHandlers): RestHandler[] {
  return [
    ...
    rest.get(
      "/v1/disks",
      handler(handlers["diskListV1"], schema.DiskListV1Params, null)
    ),
    rest.post(
      "/v1/disks",
      handler(
        handlers["diskCreateV1"],
        schema.DiskCreateV1Params,
        schema.DiskCreate
      )
    ),
    rest.get(
    ...
    rest.get(
      ...
      handler(
        handlers["diskMetricsListV1"],
        schema.DiskMetricsListV1Params,
        null
      )
    ),
    rest.get(
    ...
    rest.post(
      "/v1/images",
      handler(
        handlers["imageCreateV1"],
        schema.ImageCreateV1Params,
        schema.ImageCreate
      )
    ),
    rest.get(
    ...
    rest.get(
      ...
      handler(
        handlers["instanceDiskListV1"],
        schema.InstanceDiskListV1Params,
        null
      )
    ),
    rest.post(
    ...
    rest.get(
      "/v1/me/groups",
      handler(
        handlers["currentUserGroupsV1"],
        schema.CurrentUserGroupsV1Params,
        null
      )
    ),
    rest.get(
    ...
    rest.get(
      "/v1/organizations",
      handler(
        handlers["organizationListV1"],
        schema.OrganizationListV1Params,
        null
      )
    ),
    rest.post(
    ...
    rest.get(
      ...
      handler(
        handlers["projectPolicyViewV1"],
        schema.ProjectPolicyViewV1Params,
        null
      )
    ),
    rest.put(
    ...
    rest.get(
      ...
      handler(
        handlers["certificateListV1"],
        schema.CertificateListV1Params,
        null
      )
    ),
    rest.post(
    ...
    rest.get(
      ...
      handler(
        handlers["certificateViewV1"],
        schema.CertificateViewV1Params,
        null
      )
    ),
    rest.delete(
      "/v1/system/certificates/:certificate",
      handler(
        handlers["certificateDeleteV1"],
        schema.CertificateDeleteV1Params,
        null
      )
    ),
    rest.get(
      ...
      handler(
        handlers["physicalDiskListV1"],
        schema.PhysicalDiskListV1Params,
        null
      )
    ),
    rest.get(
    ...
    rest.get(
      ...
      handler(
        handlers["sledPhysicalDiskListV1"],
        schema.SledPhysicalDiskListV1Params,
        null
      )
    ),
    rest.get(
    ...
    rest.delete(
      ...
      handler(
        handlers["localIdpUserDeleteV1"],
        schema.LocalIdpUserDeleteV1Params,
        null
      )
    ),
    rest.post(
    ...
    rest.put(
      "/v1/system/ip-pools/:pool",
      handler(
        handlers["ipPoolUpdateV1"],
        schema.IpPoolUpdateV1Params,
        schema.IpPoolUpdate
      )
    ),
    rest.delete(
    ...
    rest.get(
      ...
      handler(
        handlers["ipPoolRangeListV1"],
        schema.IpPoolRangeListV1Params,
        null
      )
    ),
    rest.post(
      ...
      handler(
        handlers["ipPoolRangeAddV1"],
        schema.IpPoolRangeAddV1Params,
        schema.IpRange
      )
    ),
    rest.post(
    ...
    rest.get(
      "/v1/system/policy",
      handler(handlers["systemPolicyViewV1"], null, null)
    ),
    rest.put(
      "/v1/system/policy",
    ...
    rest.get(
      "/v1/users",
      handler(handlers["userListV1"], schema.UserListV1Params, null)
    ),
    rest.get(
      "/v1/vpc-firewall-rules",
      handler(
        handlers["vpcFirewallRulesViewV1"],
        schema.VpcFirewallRulesViewV1Params,
        null
      )
    ),
    rest.put(
    ...
    rest.get(
      ...
      handler(
        handlers["vpcRouterRouteListV1"],
        schema.VpcRouterRouteListV1Params,
        null
      )
    ),
    rest.post(
    ...
    rest.get(
      ...
      handler(
        handlers["vpcRouterRouteViewV1"],
        schema.VpcRouterRouteViewV1Params,
        null
      )
    ),
    rest.put(
    ...
    rest.delete(
      "/v1/vpc-router-routes/:route",
      handler(
        handlers["vpcRouterRouteDeleteV1"],
        schema.VpcRouterRouteDeleteV1Params,
        null
      )
    ),
    rest.get(
    ...
    rest.delete(
      "/v1/vpc-routers/:router",
      handler(
        handlers["vpcRouterDeleteV1"],
        schema.VpcRouterDeleteV1Params,
        null
      )
    ),
    rest.get(
    ...
    rest.delete(
      "/v1/vpc-subnets/:subnet",
      handler(
        handlers["vpcSubnetDeleteV1"],
        schema.VpcSubnetDeleteV1Params,
        null
      )
    ),
    rest.get(
    ...
    rest.get(
      "/v1/vpcs",
      handler(handlers["vpcListV1"], schema.VpcListV1Params, null)
    ),
    rest.post(
      "/v1/vpcs",
      handler(
        handlers["vpcCreateV1"],
        schema.VpcCreateV1Params,
        schema.VpcCreate
      )
    ),
    rest.get(
      "/v1/vpcs/:vpc",
      handler(handlers["vpcViewV1"], schema.VpcViewV1Params, null)
    ),
    rest.put(
      "/v1/vpcs/:vpc",
      handler(
        handlers["vpcUpdateV1"],
        schema.VpcUpdateV1Params,
        schema.VpcUpdate
      )
    ),
    rest.delete(
