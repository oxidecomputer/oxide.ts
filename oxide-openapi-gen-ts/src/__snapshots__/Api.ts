...
{"detectionThreshold": number,"local"?: string | null,"mode": BfdMode,"peer": string,"requiredRx": number,"state": BfdState,"switch": Name,};
 ...
 */
export type UninitializedSledId =
{"part": string,"serial": string,};
