...
assert<Equals<A.LldpServiceConfigCreate, z.infer<typeof V.LldpServiceConfigCreate>>>();
...
assert<Equals<A.SwitchPortAddressConfig, z.infer<typeof V.SwitchPortAddressConfig>>>();
assert<Equals<A.SwitchPortApplySettings, z.infer<typeof V.SwitchPortApplySettings>>>();
assert<Equals<A.SwitchPortBgpPeerConfig, z.infer<typeof V.SwitchPortBgpPeerConfig>>>();
...
assert<Equals<A.SwitchPortSettingsResultsPage, z.infer<typeof V.SwitchPortSettingsResultsPage>>>();
assert<Equals<A.SwitchVlanInterfaceConfig, z.infer<typeof V.SwitchVlanInterfaceConfig>>>();
assert<Equals<A.SwitchPortSettingsView, z.infer<typeof V.SwitchPortSettingsView>>>();
