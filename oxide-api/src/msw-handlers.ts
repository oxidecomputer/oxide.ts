...
export function makeHandlers(handlers: MSWHandlers): HttpHandler[] {
  return [
    ...
    http.get(
      ...
      handler(
        handlers["supportBundleList"],
        schema.SupportBundleListParams,
        null,
      ),
    ),
    http.post(
      "/experimental/v1/system/support-bundles",
      handler(
        handlers["supportBundleCreate"],
        null,
        schema.SupportBundleCreate,
      ),
    ),
    http.get(
      "/experimental/v1/system/support-bundles/:bundleId",
      handler(
        handlers["supportBundleView"],
        schema.SupportBundleViewParams,
        null,
      ),
    ),
    http.put(
    ...
    http.delete(
      "/experimental/v1/system/support-bundles/:bundleId",
      handler(
        handlers["supportBundleDelete"],
        schema.SupportBundleDeleteParams,
        null,
      ),
    ),
    http.get(
      ...
      handler(
        handlers["supportBundleDownload"],
        schema.SupportBundleDownloadParams,
        null,
      ),
    ),
    http.head(
      "/experimental/v1/system/support-bundles/:bundleId/download",
      handler(
        handlers["supportBundleHead"],
        schema.SupportBundleHeadParams,
        null,
      ),
    ),
    http.get(
    ...
    http.head(
      "/experimental/v1/system/support-bundles/:bundleId/download/:file",
      handler(
        handlers["supportBundleHeadFile"],
        schema.SupportBundleHeadFileParams,
        null,
      ),
    ),
    http.get(
      ...
      handler(
        handlers["supportBundleIndex"],
        schema.SupportBundleIndexParams,
        null,
      ),
    ),
    http.post(
    ...
    http.get(
      "/v1/affinity-groups",
      handler(
        handlers["affinityGroupList"],
        schema.AffinityGroupListParams,
        null,
      ),
    ),
    http.post(
    ...
    http.get(
      ...
      handler(
        handlers["affinityGroupView"],
        schema.AffinityGroupViewParams,
        null,
      ),
    ),
    http.put(
    ...
    http.delete(
      "/v1/affinity-groups/:affinityGroup",
      handler(
        handlers["affinityGroupDelete"],
        schema.AffinityGroupDeleteParams,
        null,
      ),
    ),
    http.get(
    ...
    http.get(
      "/v1/alert-receivers",
      handler(
        handlers["alertReceiverList"],
        schema.AlertReceiverListParams,
        null,
      ),
    ),
    http.get(
      ...
      handler(
        handlers["alertReceiverView"],
        schema.AlertReceiverViewParams,
        null,
      ),
    ),
    http.delete(
      "/v1/alert-receivers/:receiver",
      handler(
        handlers["alertReceiverDelete"],
        schema.AlertReceiverDeleteParams,
        null,
      ),
    ),
    http.get(
      ...
      handler(
        handlers["alertDeliveryList"],
        schema.AlertDeliveryListParams,
        null,
      ),
    ),
    http.post(
      ...
      handler(
        handlers["alertReceiverProbe"],
        schema.AlertReceiverProbeParams,
        null,
      ),
    ),
    http.post(
    ...
    http.post(
      ...
      handler(
        handlers["alertDeliveryResend"],
        schema.AlertDeliveryResendParams,
        null,
      ),
    ),
    http.get(
      ...
      handler(
        handlers["antiAffinityGroupList"],
        schema.AntiAffinityGroupListParams,
        null,
      ),
    ),
    http.post(
    ...
    http.get(
      ...
      handler(
        handlers["antiAffinityGroupView"],
        schema.AntiAffinityGroupViewParams,
        null,
      ),
    ),
    http.put(
    ...
    http.get(
      "/v1/auth-settings",
      handler(handlers["authSettingsView"], null, null),
    ),
    http.put(
      "/v1/auth-settings",
      handler(
        handlers["authSettingsUpdate"],
        null,
        schema.SiloAuthSettingsUpdate,
      ),
    ),
    http.get(
      "/v1/certificates",
    ...
    http.get(
      ...
      handler(
        handlers["internetGatewayList"],
        schema.InternetGatewayListParams,
        null,
      ),
    ),
    http.post(
    ...
    http.get(
      ...
      handler(
        handlers["internetGatewayView"],
        schema.InternetGatewayViewParams,
        null,
      ),
    ),
    http.delete(
      "/v1/internet-gateways/:gateway",
      handler(
        handlers["internetGatewayDelete"],
        schema.InternetGatewayDeleteParams,
        null,
      ),
    ),
    http.get(
    ...
    http.get(
      ...
      handler(
        handlers["physicalDiskView"],
        schema.PhysicalDiskViewParams,
        null,
      ),
    ),
    http.get(
    ...
    http.put(
      "/v1/system/networking/allow-list",
      handler(
        handlers["networkingAllowListUpdate"],
        null,
        schema.AllowListUpdate,
      ),
    ),
    http.post(
    ...
    http.put(
      "/v1/system/networking/bgp-announce-set",
      handler(
        handlers["networkingBgpAnnounceSetUpdate"],
        null,
    ...
    http.put(
      "/v1/system/networking/inbound-icmp",
      handler(
        handlers["networkingInboundIcmpUpdate"],
        null,
        schema.ServiceIcmpConfig,
      ),
    ),
    http.get(
    ...
    http.put(
      "/v1/system/update/target-release",
      handler(
        handlers["targetReleaseUpdate"],
        null,
        schema.SetTargetReleaseParams,
      ),
    ),
    http.get(
    ...
    http.get(
      "/v1/webhook-secrets",
      handler(
        handlers["webhookSecretsList"],
        schema.WebhookSecretsListParams,
        null,
      ),
    ),
    http.post(
    ...
    http.delete(
      ...
      handler(
        handlers["webhookSecretsDelete"],
        schema.WebhookSecretsDeleteParams,
        null,
      ),
    ),
  ];
